 ...
 */
class ActivityParserTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $activity = $this->loadFixture(__DIR__ . '/fixtures/activity-abc.md');
        $expected = $this->loadExpected(__DIR__ . '/fixtures/activity-abc-expected.yml');
    ...
    {
        $activity = $this->loadFixture(__DIR__ . '/fixtures/activity-yn.md');
        $expected = $this->loadExpected(__DIR__ . '/fixtures/activity-yn-expected.yml');
    ...
    {
        $activity = $this->loadFixture(__DIR__ . '/fixtures/activity-ynb.md');
        $expected = $this->loadExpected(__DIR__ . '/fixtures/activity-ynb-expected.yml');
    ...
    public function testParseActivityYNBSpanish()
    {
        ...
        $activity = $this->loadFixture(__DIR__ . '/fixtures/activity-ynb-spanish.md', $valid);
        $expected = $this->loadExpected(__DIR__ . '/fixtures/activity-ynb-spanish-expected.yml');
    ...
    protected function loadFixture($mdFile, $valid = null)
    {
        ...
        $parser = new ActivityParser($text);
    ...
    protected function loadExpected($ymlFile)
    {
        ...
        foreach ($activity['questions'] as $qIndex => $question) {
            $questionObj = new ActivityQuestion();
