 ...
 *
 * @deprecated Use FootNotesExtendPlugin instead.
...
class FootnotesExtraPlugin extends BasePlugin implements EventSubscriberInterface
{
    ...
    protected function createReport()
    {
        ...
        $report->setHeaders(['Old reference', 'New reference', 'Text (fragment)']);

        $report->setColumnsWidth([13, 13, 93]);
        $report->setColumnsAlignment(['center', 'center', 'left']);
        ...
        foreach ($this->footnotes as $footnote) {
            ...
            $report->addLine([$oldRef, $newRef, $text]);
        }
